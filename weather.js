const key = "102f25acd7ad51163e56349d458e387c";
...
async function search() {
  ...
  const response = await fetch(
    (input = `http://api.openweathermap.org/geo/1.0/direct?q=${phrase}&limit=5&appid=${key}`)
  );
...
document
  .querySelector((selectors = 'input[type="text"]'))
